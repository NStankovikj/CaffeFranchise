...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template name="safetyreportheader">
		...
		<xsl:if test="hl7:subjectOf2/hl7:investigationCharacteristic[hl7:code/@code=$OtherCaseIDs and hl7:code/@codeSystem=$oidReportCharacterizationCode]/hl7:value/@value">
			<duplicate>
				<xsl:call-template name="getMapping">
					<xsl:with-param name="type">YESNO</xsl:with-param>
