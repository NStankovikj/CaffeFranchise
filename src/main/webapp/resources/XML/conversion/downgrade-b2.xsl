...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="hl7:observation" mode="reaction">
		<xsl:variable name="lowLevelTerm" select="hl7:id/@root"/>
		<reaction>
			...
			<xsl:call-template name="TermHighlighted">
				<xsl:with-param name="lowLevelTerm">
					<xsl:value-of select="$lowLevelTerm"/>
				</xsl:with-param>
			</xsl:call-template>
			...
			<xsl:apply-templates select="../../hl7:subjectOf2/hl7:organizer[hl7:code/@code=$DrugInformation]/hl7:component/hl7:substanceAdministration/hl7:sourceOf1[@typeCode='SAS' and hl7:actReference/hl7:id/@root = $lowLevelTerm]" mode="SAS"/>
			<xsl:apply-templates select="../../hl7:subjectOf2/hl7:organizer[hl7:code/@code=$DrugInformation]/hl7:component/hl7:substanceAdministration/hl7:sourceOf1[@typeCode='SAE' and hl7:actReference/hl7:id/@root = $lowLevelTerm]" mode="SAE"/>
			<reactionoutcome>
				<xsl:choose>
